/*
 * 파일: Calc_Bonus_by_stmt_4.java
 * 작성일: 2024.05.31
 * 주제: 전체 고객 데이터를 Client load, statement 객체 재사용
 *      10000건 단위로 INSERT 후 COMMIT = 빈번한 COMMIT 개선
 * ******************** Transaction 단위 *********************
 * statement 객체를 1번만 생성하고 재사용 후 리소스 반납
...
//                    continue;
            ...
            // 예외를 로그 파일에 기록
            ExceptionLog.writeLog(e, Calc_Bonus_by_stmt_4.class.getName());
